...
<body>
    <div class="gradient-container">
        ...
        <div id="text">
        Hello world!
        Меня зовут Павел Горин
        Я директор по информационным технологиям (CIO)

        За 25 лет работы над IT проектами мне удалось затронуть жизнь более 150 000 человек и это только начало.
        В данный момент я ищу место в команде, которая нуждается в надёжных и устойчивых информационных решениях.
